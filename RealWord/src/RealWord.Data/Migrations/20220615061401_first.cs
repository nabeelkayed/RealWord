        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FolloweingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFollowers", x => new { x.FollowerId, x.FolloweingId });
                    table.ForeignKey(
                        name: "FK_UserFollowers_Users_FolloweingId",
                        column: x => x.FolloweingId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFollowers_FolloweingId",
                table: "UserFollowers",
                column: "FolloweingId");
